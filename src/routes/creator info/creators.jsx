  ...
  return (
    <>
      <div className= "main">
        ...
        <h2 className='Aayush'>Aayush Garg, Frontend Engineer <a href="https://www.linkedin.com/in/aayushg1414/" target= "_blank" style={{ textDecoration: 'none' }} className='linkedin-icon'><FontAwesomeIcon icon={faLinkedin} /></a></h2>
        <h2 className="Akshay">Akshay Belhe, UI/UX Specialist <a href="https://www.linkedin.com/in/akshaybelhe/" target= "_blank" style={{ textDecoration: 'none' }} className='linkedin-icon'><FontAwesomeIcon icon={faLinkedin} /></a></h2>
